...
public class TeachMgr {
	...
	public Vector getTeachList(String p_id) {
		...
		try {
			...
			String mySQL = "select t.c_id cid,t.c_id_no cid_no,c.c_name cname from teach t, course c where t.p_id=? and t.t_year=? and t.t_semester=? and t.c_id=c.c_id and t.c_id_no=c.c_id_no";
	...
	public Vector getTeachList(String p_id, int nYear, int nSemester) {
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		Vector vecList = new Vector();
