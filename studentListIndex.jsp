...
<td align="center"><a href="studentList.jsp?year=<%=year%>&semester=<%=semester%>&c_id=<%=te.getCId()%>&c_id_no=<%=te.getCIdNo()%>"><%=te.getCName()%></a></td>
...
<table width="30%" align="center">
	<FORM method="post" action="studentListIndex_verify.jsp" >
		<tr> <td>
